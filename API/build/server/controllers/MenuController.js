...
let _MenuService = _interopRequireDefault(require('../services/MenuService'));

let _MealsService = _interopRequireDefault(require('../services/MealsService'));

let _allHelpers = _interopRequireDefault(require('../helpers/allHelpers'));
...
let _default = new MenuController();
